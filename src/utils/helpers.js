...
export const getPeriodDays = (p) => {
  ...
  const m = { mensal: 30, bimensal: 60, bimestral: 60, trimestral: 90, quadrimestral: 120, semestral: 180, anual: 365 };
...
export const mapClientFromDB = (c) => ({
  ...
  dataNascimentoFilho: c.data_nascimento_filho,
  ...
  seguroNaoAplica: c.seguro_nao_aplica,
  ...
  tentativas_contato: c.tentativas_contato ?? 0,
...
const CLIENT_DB_COLS = new Set([
  ...
  "liquidez_desejada", "liquidez_atual", "liquidez_produtos", "taxa_contratada", "valor_minimo_contrato", "receita_mensal", "custo_vida", "data_nascimento_filho",
...
export const mapClientToDB = (c) => {
  ...
  aporte_mensal_max: toNum(c.aporte_mensal_max ?? c.aporteMensalMax),
    ...
    data_nascimento_filho: c.data_nascimento_filho ?? c.dataNascimentoFilho ?? "",
    ...
    seguro_nao_aplica: (c.seguro_vida ?? c.seguroVida) === "nao_aplica",
    seguro_vida: (c.seguro_vida ?? c.seguroVida) === "nao_aplica" ? false : !!(c.seguro_vida ?? c.seguroVida ?? false),
    ...
    tentativas_contato: Number(c.tentativas_contato ?? 0),
    ...
    prev_nao_aplica: c.pgbl === "nao_aplica",
    pgbl: c.pgbl === "nao_aplica" ? false : !!(c.pgbl ?? false),
    vgbl: c.pgbl === "nao_aplica" ? false : !!(c.vgbl ?? false),
